...
return [
    ...
    'routes' => [
        [
             ...
             */
            'exclude' => [
                'application.index', 'application.create', 'application.destroy', 'application.update', 'application.show', 'application.edit', 'defender.index', 'defender.create', 'defender.show', 'defender.update', 'defender.destroy', 'defender.edit', 'operative.index', 'operative.create', 'operative.update', 'operative.destroy', 'operative.show', 'operative.edit', 'documentation.store', 'documentation.create', 'documentation.show', 'documentation.update', 'documentation.destroy', 'documentation.edit'
            ],
